 ...
 */
public final class MyOwnASCIIFoldingFilter extends TokenFilter {
  ...
  public MyOwnASCIIFoldingFilter(TokenStream input)
  {
    this(input, false);
  }
   ...
   **/
  public MyOwnASCIIFoldingFilter(TokenStream input, boolean preserveOriginal)
  {
    super(input);
