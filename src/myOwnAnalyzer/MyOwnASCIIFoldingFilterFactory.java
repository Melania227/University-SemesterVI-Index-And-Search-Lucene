 ...
 */
public class MyOwnASCIIFoldingFilterFactory extends TokenFilterFactory {
  ...
  public MyOwnASCIIFoldingFilterFactory(Map<String,String> args) {
    super(args);
  ...
  public TokenStream create(TokenStream input) {
    return new MyOwnASCIIFoldingFilter(input, preserveOriginal);
  }
  ...
  public TokenStream normalize(TokenStream input) {
    ...
    return new MyOwnASCIIFoldingFilter(input, false);
  }
